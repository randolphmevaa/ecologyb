...
export default function UpdatedHeader({ contactId }: UpdatedHeaderProps) {
  ...
  const mprEmail = contact.maprEmail || contact.mpremail || "maprimerenov@exemple.com";
  const mprPassword = contact.mprPassword || contact.mprpassword || "test123";
  ...
  return (
    <div className="relative pt-3">
      {/* Sample text positioned above the header */}
