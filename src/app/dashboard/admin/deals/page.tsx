...
const SAMPLE_DEALS: Deal[] = [
  {
    ...
    ratioInstallateur: 0.7,
    ratioBeneficiaire: 0.3,
    active: true,
  },
  {
    id: "D002",
    nomDuDeal: "Pompe à chaleur premium",
    ratioInstallateur: 0.65,
    ratioBeneficiaire: 0.35,
    active: true,
  },
  {
    id: "D003",
    nomDuDeal: "Isolation complète",
    ratioInstallateur: 0.6,
    ratioBeneficiaire: 0.4,
    active: false,
  },
  {
    id: "D004",
    nomDuDeal: "Solaire résidentiel",
    ratioInstallateur: 0.75,
    ratioBeneficiaire: 0.25,
    active: true,
  },
];
              ...
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-6">
                <div className="relative">
                  ...
                  <p className="text-[#213f5b] opacity-75 pl-2">
                    Gérez les deals et les ratios de distribution
                  </p>
                ...
                {filteredDeals.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-[#213f5b]">
                    ...
                    <p className="text-sm opacity-75 mb-6">
                      Ajoutez un nouveau deal ou modifiez vos critères de
                      recherche
                    </p>
                    <Button
                      onClick={handleAddNewDeal}
                        ...
                        <div className="p-5 border-b border-[#eaeaea] bg-gradient-to-r from-white to-[#f8fafc]">
                          <div className="flex justify-between items-start mb-2">
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                <h3 className="font-bold text-[#213f5b] line-clamp-1">
                                  {deal.nomDuDeal}
                                </h3>
                          ...
                          <div className="space-y-4 mb-4">
                            <div>
                              <div className="flex justify-between mb-1">
                                ...
                                <span
                                  className={`text-sm font-medium ${getRatioColor(
                                    deal.ratioInstallateur
                                  )}`}
                                >
                                  {formatDecimal(deal.ratioInstallateur)}
                                </span>
                              </div>
                            ...
                            <div>
                              <div className="flex justify-between mb-1">
                                ...
                                <span
                                  className={`text-sm font-medium ${getRatioColor(
                                    deal.ratioBeneficiaire
                                  )}`}
                                >
                                  {formatDecimal(deal.ratioBeneficiaire)}
                                </span>
                              </div>
                              <div className="w-full bg-gray-200 rounded-full h-2.5">
                                <div
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden">
                  <div className="bg-gradient-to-r from-white to-[#f8fafc] border-b p-6">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-xl font-bold text-[#213f5b]">
                        {selectedDeal ? "Modifier le deal" : "Ajouter un deal"}
                      </h2>
                    </div>
                    <p className="text-[#213f5b] opacity-75 ml-3 pl-3">
                      Informations du deal et répartition des ratios
                    </p>
                  </div>
                  <div className="p-6">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                          <div
                            ...
                            style={{
                              width: `${
                                parseDecimal(dealForm.ratioInstallateur) * 100
                              }%`,
                            }}
                          ></div>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                          <div
                            ...
                            style={{
                              width: `${
                                parseDecimal(dealForm.ratioBeneficiaire) * 100
                              }%`,
                            }}
                          ></div>
                        </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <label className="relative inline-flex items-center cursor-pointer">
                          ...
                          <span className="ml-3 text-sm font-medium text-[#213f5b]">
                            Actif
                          </span>
                        </label>
                      </div>
                  ...
                  <div className="flex justify-end gap-3 p-6 border-t border-[#eaeaea]">
                    ...
                    <Button
                      ...
                      // Removed total-ratio validation from the disabled prop
                      disabled={!dealForm.nomDuDeal}
