...
// Sample documents data for the technician's documents page
const documents = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: "Manuel de maintenance - Chauffe-eau solaire individuel",
  ...
  {
    id: 3,
    title: "Procédure technique - Chauffe-eau thermodynamique",
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        >
          ...
          <p className="mt-2 text-lg text-gray-600">
            Accédez aux ressources techniques et documentations pour vos interventions sur nos solutions énergétiques spécialisées.
          </p>
        </motion.div>
