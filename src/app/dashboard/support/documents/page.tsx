...
// Sample documents data for the support team
const documents = [
  {
    id: 1,
  ...
  {
    id: 2,
    title: "Procédure de dépannage - Chauffe-eau solaire individuel",
  ...
  {
    id: 4,
    title: "Documentation de maintenance - Système Solaire Combiné",
  ...
  },
  {
    ...
    solution: "Pompes a chaleur",
    uploadedDate: "2025-03-07",
    fileType: "HTML",
    size: "500KB",
  },
];

export default function SupportDocumentsDashboard() {
  const [filter, setFilter] = useState("Tous");

  // Filter documents based on the selected energy solution
      ...
      <main className="max-w-7xl mx-auto p-6">
        ...
        >
          ...
          <p className="mt-2 text-lg text-gray-600">
            Accédez aux documents et ressources pour assurer le support sur nos solutions énergétiques spécialisées.
          </p>
        </motion.div>
