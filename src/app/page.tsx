...
export default function Home() {
  ...
  const slides = [
    {
      image: "https://images.blush.design/8b20777ff46a2fdeed929f4ed34239ce?w=920&auto=compress&cs=srgb", // Replace with your illustration URL
      title: "Planification Stratégique",
      description: "Organisez et planifiez vos projets énergétiques avec précision.",
    },
    {
      image: "https://images.blush.design/4c8f50e7179ced438982fe46d508003f?w=920&auto=compress&cs=srgb", // Replace with your illustration URL
      title: "Suivi en Temps Réel",
      description: "Surveillez l'avancement de vos projets en temps réel pour une réactivité optimale.",
    },
    {
      image: "https://images.blush.design/b7b5556dfd73e6ba84f27df079cc65f8?w=920&auto=compress&cs=srgb", // Replace with your illustration URL
      title: "Optimisation & Rapport",
      description: "Analysez et optimisez vos opérations pour une performance maximale.",
    },
  ];
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // En cas de succès, récupère le rôle et redirige
    ...
    <>
      ...
      <div className="min-h-screen flex bg-[#ffffff]">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(45deg, #ffffff, #bfddf9, #d2fcb2)",
          ...
          <div className="w-full max-w-md relative z-10">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1 text-right">
                      <a
                        href="#"
                        className="text-sm text-[#213f5b] hover:underline"
                      >
                        Mot de passe oublié
                      </a>
                    </div>
            ...
            <div className="mt-4 flex flex-col items-center gap-2">
              <div className="flex items-center">
                ...
                {/* Add more star icons here if needed */}
              </div>
              <span className="text-sm text-[#213f5b]">
